    ...
    def summary(self, model="sdid"):
        if model == "sdid":
            ...
            if self.sdid_se != None:
                ...
                print(
                    f"90% CI ({att - 1.645*self.sdid_se :.3f}, {att + 1.645*self.sdid_se:.3f})"
                )
            else:
            ...
            if self.sdid_se != None:
                ...
                print(
                    f"90% CI ({att - 1.645*self.sc_se :.3f}, {att + 1.645*self.sc_se:.3f})"
                )
            else:
                print(f"point estimate: {att:.3f}")
            ...
            if self.sdid_se != None:
                ...
                print(
                    f"90% CI ({att - 1.645*self.did_se :.3f}, {att + 1.645*self.did_se:.3f})"
                )
            else:
                print(f"point estimate: {att:.3f}")
